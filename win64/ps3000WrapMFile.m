...
%This function was generated by loadlibrary.m parser version  on Mon Jan 11 14:40:36 2016
%perl options:'ps3000Wrap.i -outfile=ps3000WrapMFile.m -thunkfile=ps3000Wrap_thunk_pcwin64.c -header=ps3000Wrap.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'ps3000Wrap_thunk_pcwin64');
% extern int16_t __stdcall GetStreamingLastValues ( int16_t handle ); 
...
% extern int16_t __stdcall AvailableData ( int16_t handle , int16_t * overflow , uint32_t * triggeredAt , int16_t * triggered , int16_t * auto_stop , uint32_t * nValues ); 
...
% extern int16_t __stdcall ClearTriggerInfo ( int16_t handle ); 
...
% extern int16_t __stdcall SetDataBuffer ( int16_t handle , int16_t channel , int16_t * buffer , uint32_t bufferLength ); 
...
% extern void __stdcall SetDataBuffers ( int16_t handle , int16_t channel , int16_t * minBuffer , int16_t * maxBuffer ); 
...
% extern int16_t __stdcall SetDataBuffersV2 ( int16_t handle , int16_t channel , int16_t * minBuffer , int16_t * maxBuffer , uint32_t bufferLength ); 
...
% extern int16_t __stdcall setChannelCount ( int16_t handle , int16_t channelCount ); 
...
% extern int16_t __stdcall clearFastStreamingParameters ( int16_t handle ); 
