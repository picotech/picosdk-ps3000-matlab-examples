...
%This function was generated by loadlibrary.m parser version  on Mon Jan 11 14:40:32 2016
%perl options:'ps3000.i -outfile=ps3000MFile.m -thunkfile=ps3000_thunk_pcwin64.c -header=ps3000.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'ps3000_thunk_pcwin64');
